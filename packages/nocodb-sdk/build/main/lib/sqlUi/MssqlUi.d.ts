...
export declare class MssqlUi implements SqlUi {
    ...
    getDefaultLengthIsDisabled(type: string): boolean;
    getDefaultValueForDatatype(type: string): "" | "eg: ";
