...
export interface SourceType {
     ...
     * @example mysql2
     */
    type?: 'mssql' | 'mysql' | 'mysql2' | 'oracledb' | 'pg' | 'snowflake' | 'sqlite3' | 'databricks';
}
/**
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
        csvExport: (orgs: string, baseName: string, tableName: string, type: 'csv' | 'excel', params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        export: (orgs: string, baseName: string, tableName: string, viewName: string, type: 'csv' | 'excel', params?: RequestParams) => Promise<any>;
    };
    dbCalendarViewRow: {
        /**
